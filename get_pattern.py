...
class KeyBoard:
    buttons = ['현재 주가 확인','투자자 성향분석','금융 상품 추천','내일 예측 주가 확인','금융 용어 사전', '도움말']
    
    Q1 =  ['19세 이하','20세 이상 40세 이하','41세 이상 50세 이하','51세 이상 60세 이하', '61세 이상', '처음으로']
    ...
    Q10 = ['여유자금운용','퇴직금운용','생계자금 마련','대출금 상환','처음으로']
    
    end = ["더 보기","처음으로"]
    survey = ["다시하기","처음으로"]
    terms = ["다른 용어 확인", "처음으로"]
    
    fp1 = ["예상 주가 확인","예측 서비스 종목 리스트","처음으로"]
    fp2 = ["다른 종목의 예상 주가 확인", "처음으로"]
    rtp = ["다른 종목 시가 확인","처음으로"]
    tendency = ["공격투자형","적극투자형","위험중립형","안정추구형","안정형", "처음으로"]
    
    terms1=["금융 용어 검색","금융용어 사전 리스트","처음으로"]
    terms2=["금융 용어 검색","처음으로"]
